      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <section className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Basic Controls</h2>
            <ul className="space-y-3 text-gray-600">
              ...
              <li className="flex items-center">
                <span className="bg-gray-200 px-2 py-1 rounded mr-2">Q/E</span>
              ...
              <li className="flex items-center">
                <span className="bg-gray-200 px-2 py-1 rounded mr-2">Mouse</span>
                <span>Rotate camera view</span>
              </li>
              <li className="flex items-center">
                <span className="bg-gray-200 px-2 py-1 rounded mr-2">Scroll</span>
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            ...
            <ul className="space-y-3 text-gray-600">
              <li>• Switch between User and Target views to compare your build</li>
